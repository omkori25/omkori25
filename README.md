...
🐍 Core skills: Python & SQL<br>
📊 Experience with real-world datasets for analytics and forecasting<br>
🤖 Interested in machine learning, predictive analytics, and applied AI<br>
🚀 Focused on clean, efficient, and scalable solutions
</p>

<p align="center">
I enjoy working on end-to-end projects — from data preprocessing and modeling to analysis and decision support.<br>
